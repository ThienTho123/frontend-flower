...
const AppRoutes = () => {
  ...
  const adminRoutes = ["/dashboard", "/AdminOder", "/AdminBanner", "/AdminAccount", "/AdminOrderDetail", "/AdminCategory", "/AdminComment", "/AdminCommentType", "/AdminDiscount", "/AdminFlower", "/AdminFlowerImage", "/AdminFlowerSize" ];  
