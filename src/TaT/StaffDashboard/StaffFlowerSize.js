...
const StaffFlowerSize = () => {
  ...
  useEffect(() => {
    const fetchFlowerSizes = async () => {
      try {
        const response = await fetch(
          "http://localhost:8080/api/v1/staff/flowersize",
          {
            headers: {
    ...
    const fetchFlowerOptions = async () => {
      try {
        const response = await fetch(
          "http://localhost:8080/api/v1/staff/flower",
          {
            headers: {
              Authorization: `Bearer ${accesstoken}`,
            },
  ...
  const handlePreorder = async (id) => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/v1/staff/flowersize/preorderable/${id}`,
        {
  ...
  const handleToggleAllPreorder = async () => {
    try {
      const response = await fetch(
        "http://localhost:8080/api/v1/staff/flowersize/preorderable",
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${accesstoken}`,
