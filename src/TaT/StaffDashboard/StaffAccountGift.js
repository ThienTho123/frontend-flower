            ...
            <tbody>
              {accountGifts.map((gift) => (
                <tr key={gift.id}>
                  ...
                  <td>
                    <Link
                      to={`/StaffAccountGift/edit/${gift.id}`}
                      className="gift-link"
                    >
                      {gift.id}
                    </Link>
                  ...
                  <td>{gift.status}</td>
                  <td>
                    <Link to={`/StaffAccountGift/edit/${gift.id}`}>
...
export default StaffAccountGift;