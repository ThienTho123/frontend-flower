...
const AdminCustomOrderDetail = () => {
  ...
  return (
    <div className="admin-custom-order-detail-container">
      ...
      {orderDetail.image && (
        <div className="admin-custom-order-detail-card">
          ...
          <img
            ...
            alt="Đơn hàng"
            className="admin-custom-order-detail-image"
          />
        </div>
      )}
        ...
        <div className="admin-custom-order-detail-card">
          ...
          <div className="admin-custom-order-detail-form-section">
            ...
            <div className="admin-custom-order-detail-upload-container">
              <input
                ...
                accept="image/*"
                className="admin-custom-order-detail-file-input"
                disabled={uploading}
              />
              {imageUrl && (
                <button
            ...
            {imageUrl && (
              <div className="admin-custom-order-detail-image-preview">
                ...
                <img
                  src={imageUrl}
                  alt="Preview"
                  className="admin-custom-order-detail-preview-image"
                />
              </div>
            )}
          </div>
          ...
          <div className="admin-custom-order-detail-actions">
            <button
              ...
              className="admin-custom-order-detail-btn admin-custom-order-detail-btn--success"
            >
              <span>✅</span>
            ...
            <button
              ...
              className="admin-custom-order-detail-btn admin-custom-order-detail-btn--danger"
            >
              <span>❌</span>
              <span>Từ Chối</span>
            </button>
      ...
      {/* Modal */}
      {isModalOpen && (
        <div className="admin-custom-order-detail-modal-overlay">
          <div className="admin-custom-order-detail-modal">
            <div className="admin-custom-order-detail-modal-content">
              {modalType === "confirm" ? (
                <div className="admin-custom-order-detail-modal-icon admin-custom-order-detail-modal-icon--warning">
                  <span>⚠️</span>
                </div>
              ) : (
                <div className="admin-custom-order-detail-modal-icon admin-custom-order-detail-modal-icon--info">
                  <span>ℹ️</span>
                </div>
              )}
              <div className="admin-custom-order-detail-modal-text">
                <p>{modalMessage}</p>
              </div>
            </div>
            ...
            <div className="admin-custom-order-detail-modal-actions">
              {modalType === "confirm" ? (
                <>
                  <button
                    onClick={closeModal}
                    className="admin-custom-order-detail-btn admin-custom-order-detail-btn--gray"
                  >
                    Hủy
                  </button>
                  <button
