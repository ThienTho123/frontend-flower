...
const AdminOrderDetail = ({ orderID }) => {
    ...
    const fetchOrderDetails = async () => {
      try {
        const response = await fetch(
          `https://deploybackend-j61h.onrender.com/api/v1/admin/orderdetail`,
          {
            headers: {
  ...
  const handleSave = async (orderDetailId) => {
    ...
    try {
      const response = await fetch(
        `https://deploybackend-j61h.onrender.com/api/v1/admin/orderdetail/${orderDetailId}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${accesstoken}`,
  ...
  const handleSoftDelete = async (orderDetailId) => {
    try {
      const response = await fetch(
        `https://deploybackend-j61h.onrender.com/api/v1/admin/orderdetail/softdelete/${orderDetailId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${accesstoken}`,
  ...
  const handleHardDelete = async (orderDetailId) => {
    try {
      const response = await fetch(
        `https://deploybackend-j61h.onrender.com/api/v1/admin/orderdetail/harddelete/${orderDetailId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${accesstoken}`,
