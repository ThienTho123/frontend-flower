              ...
              {comments.map((comment) => (
                <tr key={comment.id}>
                  ...
                  <td>
                    ...
                    <Link to={`/account/sendcomment/${comment.id}`} className="comment-link">{comment.id}</Link>
                  </td>
                  <td>
                    {/* Link tới trang chi tiết với title */}
                    <Link to={`/account/sendcomment/${comment.id}`} className="comment-link">{comment.title}</Link>
                    </td>
                  <td>{comment.text}</td>
